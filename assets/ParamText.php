...
class ParamText extends Csv
{
    ...
    const LABELS = ["editing-year", "editing-month", "invoice-year", "invoice-month", "invoice-version", "invoice-project", "invoice-id", "invoice-type", "invoice-ref",
                    ...
                    "table-paramfact-0", "table-paramfact-1", "table-paramfact-2", "table-paramfact-3",
                    "table-articlesap-0", "table-articlesap-1", "table-articlesap-2", "table-articlesap-3", "table-articlesap-4", "table-articlesap-5", "table-articlesap-6", "table-articlesap-7", "table-articlesap-8",
                    "table-overhead-0", "table-overhead-1", "table-overhead-2",
                    "table-base-0", "table-base-1",
                    "table-classeclient-0", "table-classeclient-1", "table-classeclient-2", "table-classeclient-3", "table-classeclient-4", "table-classeclient-5", "table-classeclient-6", "table-classeclient-7", "table-classeclient-8",
                    "table-plateforme-0", "table-plateforme-1", "table-plateforme-2",
                    "table-partenaire-0", "table-partenaire-1",
                    "table-classeprestation-0", "table-classeprestation-1", "table-classeprestation-2", "table-classeprestation-3", "table-classeprestation-4", "table-classeprestation-5", "table-classeprestation-6", "table-classeprestation-7", "table-classeprestation-8", "table-classeprestation-9",
                    "table-categorie-0", "table-categorie-1", "table-categorie-2", "table-categorie-3", "table-categorie-4", "table-categorie-5", "table-categorie-6",
                    "table-groupe-0", "table-groupe-1", "table-groupe-2", "table-groupe-3", "table-groupe-4", "table-groupe-5", "table-groupe-6", "table-groupe-7", "table-groupe-8", "table-groupe-9",
                    "table-ciseau-0", "table-ciseau-1", "table-ciseau-2", "table-ciseau-3", "table-ciseau-4", "table-ciseau-5",
                    "table-coeffprestation-0", "table-coeffprestation-1", "table-coeffprestation-2",
                    "table-basecateg-0", "table-basecateg-1", "table-basecateg-2",
                    "table-categprix-0", "table-categprix-1", "table-categprix-2",
